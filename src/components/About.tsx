          ...
          <div>
            ...
            <div className="bg-[#46A8AB]/5 p-6 rounded-lg mb-8">
              ...
              <p className="text-gray-700">
                To deliver world-class creative solutions in videography, design, and digital education thatpromoting Nigerian culture, 
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index} className="text-center p-6 bg-gray-50 rounded-lg hover:bg-[#46A8AB]/5 transition">
